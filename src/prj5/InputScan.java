...
public class InputScan {
     ...
     * submission
     * 
     * @param peopleFileString
     *            people file locaiton
    ...
    public InputScan(String peopleFileString, String songFileString) {
        ...
        while (iter.hasNext()) {
            ...
            System.out.println("reading" + testing[output.getDataLoc()]
                .getPercentReadHeard() + " art" + testing[output.getDataLoc()]
                    .getPercentArtHeard() + " sports" + testing[output
                        .getDataLoc()].getPercentSportsHeard() + " music"
                + testing[output.getDataLoc()].getPercentMusicHeard());
            System.out.println("likes");
            System.out.println("reading" + testing[output.getDataLoc()]
                .getPercentReadLike() + " art" + testing[output.getDataLoc()]
                    .getPercentArtLike() + " sports" + testing[output
                        .getDataLoc()].getPercentSportsLike() + " music"
                + testing[output.getDataLoc()].getPercentMusicLike());
            System.out.println();
        }
        iter = songs.iterator();
        songs.sortTitle();
